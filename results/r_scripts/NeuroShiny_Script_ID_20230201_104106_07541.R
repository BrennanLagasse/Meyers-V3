...
binned_data <- file.path('/home/wz354/project/DecodingProject/DecodingProject/data/binned/ZD_150bins_50sampled.Rda') 
...
log_save_results(DECODING_RESULTS, 
	file.path('/home/wz354/project/DecodingProject/DecodingProject/results', 'decoding_results', 'decoding_result_files', ''))
